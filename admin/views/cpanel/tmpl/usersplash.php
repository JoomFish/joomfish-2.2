 ...
 * -----------------------------------------------------------------------------
 * $Id: default.php 1462 2010-03-16 15:47:13Z akede $
 * @package joomfish
 * @subpackage Views
 *
*/
...
<div id="jfsplashcontainer" style="width:782px; height: 100%; margin: 0; padding: 0;">
	<div id="jfsplashcontent">
		<div id="jfsplashwelcome">
			...
			<img id="jfsplash-logo" src="<?php echo JURI::root();?>administrator/components/com_joomfish/assets/images/joomfish_slogan.png" border="0" alt="<?php echo JText::_('JOOM!FISH') .'-'. JText::_('JOOMFISH_HEADER');?>" />
			...
			<img id="btn-startvideo" src="<?php echo JURI::root();?>administrator/components/com_joomfish/assets/images/splash_btn_startvideo.png" border="0" alt="<?php echo JText::_('Click to start the video');?>" />
		</div>
